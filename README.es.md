...
**Observador de actualizaciones de imágenes de contenedores: 23 registros, 21 proveedores de notificaciones y acciones.**
...
**Estado de versiones (16 de septiembre de 2026):** El candidato v1.7 publicado es [v1.7.0-rc.16](https://github.com/CodesWhat/drydock/releases/tag/v1.7.0-rc.16). Este checkout contiene el **desarrollo de v1.8, aún sin publicar**; las funciones v1.8 de la [hoja de ruta](#roadmap) no están incluidas en ese candidato. Los aspectos destacados de RC10 que siguen se conservan como notas históricas.
...
| 🔔  | **21 activadores**                                        | 17 canales de notificación (Slack, Discord, Telegram, Teams, SMTP, MQTT, ntfy y más) además de acciones de Docker, Docker Compose, Portainer y Command, con plantillas por evento/proveedor, vista previa en vivo, filtrado de umbral y modo por lotes.                                                                                                                                                                                                                                                                                                                                                    |
...
<tr><td>Canales de activación / notificación</td><td align="center">21</td><td align="center">17</td><td align="center">17</td><td align="center">~20</td></tr>
...
<tr><td>Autenticación OIDC / SSO</td><td align="center">✅</td><td align="center">✅</td><td align="center">✅</td><td align="center">✅</td></tr>
<tr><td>Canales de activación / notificación</td><td align="center">21</td><td align="center">11+</td><td align="center">5</td><td align="center">15+</td></tr>
...
| **v1.8.0** | Gestión de flotas y configuración en vivo | **Integrado en `dev/v1.8`, sin publicar:** SQLite, cola de aprobación, configuración YAML, editores acotados de políticas de observadores/notificaciones/acciones y plantillas de resúmenes de seguridad, actualizaciones paralelas y masivas selectivas ([#232](https://github.com/CodesWhat/drydock/discussions/232)), interfaz de dependencias, inventario y limpieza de imágenes, estado de flota y actualización de inventario, agrupación por etiquetas compartible, ventanas de mantenimiento solo para instalaciones ([#946](https://github.com/CodesWhat/drydock/discussions/946)), autenticación propia, claves API con alcance limitado ([#469](https://github.com/CodesWhat/drydock/discussions/469)) y progreso/dispositivos de Home Assistant ([#210](https://github.com/CodesWhat/drydock/discussions/210)). **En revisión:** enrutamiento por grupo exacto solo para notificaciones ([#1251](https://github.com/CodesWhat/drydock/pull/1251)). **Pendiente:** La configuración en vivo ampliada y las políticas heredadas de grupos y acciones requieren decisiones sobre quién controla los ajustes; TOTP necesita un contrato aprobado; el observador de listas estáticas de imágenes queda para después de GA. |
...
**Requisitos pendientes de la comunidad:** Las actualizaciones y reinicios de dependencias entre hosts ([#219](https://github.com/CodesWhat/drydock/discussions/219)), la madurez basada en el número de versiones ([#558](https://github.com/CodesWhat/drydock/discussions/558)) y un valor predeterminado para comprobar digests en toda la flota ([#657](https://github.com/CodesWhat/drydock/discussions/657)) aún no están implementados. El orden de dependencias en un mismo host y su nueva interfaz no cubren la solicitud para hosts remotos. La detección de compilaciones locales y la selección segura de una acción de reconstrucción siguen siendo trabajo futuro ([#897](https://github.com/CodesWhat/drydock/discussions/897)); ninguna de estas entradas supone un compromiso de fecha de lanzamiento.
