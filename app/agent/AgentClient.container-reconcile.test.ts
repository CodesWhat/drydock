/**
 * DR-103 regression coverage: every AgentClient container-reconcile entry point used to
 * call processAuthoritativeContainers() (insert/update) BEFORE pruneOldContainers()
