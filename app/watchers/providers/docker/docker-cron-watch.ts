 ...
 * the cron schedule, the docker-events debounce and the startup timer can
 * all ask for one while the previous scan is still running. Without a
 * guard each overlapping call ran its own
