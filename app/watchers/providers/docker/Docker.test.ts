...
describe('Docker Watcher', () => {
  ...
  describe('Initialization', () => {
    ...
    // started" log line from the cron schedule, discovery-settle, or
    // startup timer. Exercises the real wrapper (not a replaced vi.fn())
    // via mockDebounce's identity passthrough set up in beforeEach.
