...
test('clearDetectedUpdateState should drop maturityGatePendingSince', () => {
  const containerValidated = container.validate({
    id: 'container-clear-maturity-pending-123456789',
    name: 'test',
    watcher: 'test',
    maturityGatePendingSince: '2026-02-24T09:15:00.000Z',
    image: {
      id: 'image-clear-maturity-pending-123456789',
      registry: {
        name: 'hub',
        url: 'https://hub',
      },
  ...
  expect(cleared.maturityGatePendingSince).toBeUndefined();
});
