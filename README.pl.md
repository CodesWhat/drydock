...
| **v1.8.0** | Zarządzanie flotą i konfiguracja na żywo | Migracja magazynu SQLite, kolejka zatwierdzeń dla poszczególnych aktualizacji, konfiguracja YAML, konfiguracja interfejsu użytkownika na żywo, aktualizacje równoległe, selektywne aktualizacje zbiorcze ([#232](https://github.com/CodesWhat/drydock/discussions/232)), interfejs porządkowania zależności, menedżer obrazów i czyszczenie, obserwator statycznych list obrazów, okno konserwacji domyślnie ograniczone do instalacji ([#946](https://github.com/CodesWhat/drydock/discussions/946)), własny łańcuch uwierzytelniania zastępujący Passport.js (już dostarczony), uwierzytelnianie dwuskładnikowe TOTP, klucze API o określonym zakresie, z limitami szybkości na klucz i kaskadowym unieważnianiem, dla integracji HA/pulpitu nawigacyjnego ([#469](https://github.com/CodesWhat/drydock/discussions/469)), postęp aktualizacji Home Assistant + urządzenia przypisane do poszczególnych kontenerów ([#210](https://github.com/CodesWhat/drydock/discussions/210)) |
