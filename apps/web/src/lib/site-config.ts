...
export const SITE_CONFIG = {
  ...
  description:
    "Open source container update monitoring built in TypeScript. Auto-discover containers, detect image updates, and trigger updates and notifications across 21 services.",
