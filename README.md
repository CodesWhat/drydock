...
- **Chinese (Simplified) UI** — First non-English locale: 1,100+ translated strings across every view, contributed by [TianMiao](https://github.com/TianMiao) ([PR #331](https://github.com/CodesWhat/drydock/discussions/331)). Switch languages in Config > Appearance. The i18n framework is ready for additional locales; Crowdin integration is planned for v1.8.0.
...
| **v1.8.0** | Fleet Management & Live Config | YAML config, live UI config panels, volume browser, parallel updates, SQLite store migration + ID-based container identity, Crowdin integration (i18n framework shipped in v1.5; Chinese locale bundled as of v1.5.0-rc.17) |
