...
| **v1.5.1** | Scanner Decoupling & Dashboard | Backend-based scanner execution (docker/remote), Grype provider, scanner asset lifecycle, custom zero-dependency dashboard grid (replaces grid-layout-plus, #281), fixed-height Containers table redesign with explicit column widths, overflow handling, and safe virtualization re-enable |
