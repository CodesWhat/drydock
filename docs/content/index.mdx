...
Drydock monitors your Docker containers for image updates. It auto-discovers running containers, checks 24 registries for new versions, and triggers notifications or automated updates via 20+ services.
...
- 📦 24 registry integrations (Docker Hub, GHCR, ECR, GCR, GAR, GitLab, Quay, and more)
