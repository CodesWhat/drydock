...
DOCKER_ARGS+=(--env "DD_REGISTRY_GCR_PRIVATE_PRIVATEKEY=${GCR_PRIVATE_KEY:------BEGIN PRIVATE KEY-----\nMIIEvgIBADANBgkqhkiG9w0BAQEFAASCBKgwggSkAgEAAoIBAQDZ\n-----END PRIVATE KEY-----}")
	...
	DOCKER_ARGS+=(
		...
		--env DD_AUTH_BASIC_JOHN_HASH='scrypt$16384$8$1$ZHJ5ZG9jay1iYXNpYy1hdXRoLXNhbHQ=$7uGC8v5Vk0C2E97nHYL7eOu1fHyFR3tsOkSxC0ARjHR3EelbtXns9E/KXGDVyD0KbnRMgXYVwSX/V+DPCZ/uLg=='
		drydock
	)
