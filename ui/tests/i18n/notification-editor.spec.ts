...
import english from '@/locales/en/notificationEditor.json';

const locales = import.meta.glob('../../src/locales/*/notificationEditor.json', {
  eager: true,
  import: 'default',
});
...
it.each(SUPPORTED_LOCALES)('provides notification policy messages for %s', (locale) => {
  const value = locales[`../../src/locales/${locale}/notificationEditor.json`];
