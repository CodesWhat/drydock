...
<template>
  <div class="flex flex-col" style="height: calc(100% - 0px);">
    <LogViewer
      ...
      error-class="mx-3 mt-3 text-[11px] px-3 py-2 dd-rounded"
      empty-class="px-3 py-4 text-[11px] dd-text-muted text-center"
    >
      <template #controls>
      ...
      <template #entry="{ entry }">
        ...
        >
          ...
          <span
            class="shrink-0 w-11 text-right font-semibold uppercase text-[10px]"
            :style="{
