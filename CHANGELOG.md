...
- **CI dependency metadata is cleaner.** The Playwright workflow comment now matches its actual Chromium-only matrix ([#486](https://github.com/CodesWhat/drydock/issues/486)), and the unused `@types/node-cron` package was removed from the backend workspace ([#489](https://github.com/CodesWhat/drydock/issues/489)).
