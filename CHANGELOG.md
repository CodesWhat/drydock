...
- **Pinned-tag newer-version insight now renders as a stacked current→newer tag view with a Major/Minor/Patch pill in the info palette across list/card/detail views, replacing the old "Newer available" badge + hover tooltip.** ([#498](https://github.com/CodesWhat/drydock/issues/498))
