...
- **Tearing a watcher down while a Docker event request was in flight could resurrect it.** The late callback fired against already-cleaned-up state and reconnected a watcher that was being removed. Superseded requests are now ignored and their streams destroyed. ([#904](https://github.com/CodesWhat/drydock/pull/904))
