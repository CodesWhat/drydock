...
**Container-Image-Update-Watcher – 23 Register, 21 Benachrichtigungs- und Aktionsanbieter.**
...
| 🔔  | **21 Auslöser**                                | 17 Benachrichtigungskanäle (Slack, Discord, Telegram, Teams, SMTP, MQTT, ntfy und mehr) plus Docker-, Docker Compose-, Portainer- und Command-Aktionen, mit Vorlagen pro Ereignis/Anbieter, Live-Vorschau, Schwellenwertfilterung und Batch-Modus.                                                                                                                                                                                                                                                                                                                     |
...
<tr><td>Trigger-/Benachrichtigungskanäle</td><td align="center">21</td><td align="center">17</td><td align="center">17</td><td align="center">~20</td></tr>
...
<tr><td>OIDC-/SSO-Authentifizierung</td><td align="center">✅</td><td align="center">✅</td><td align="center">✅</td><td align="center">✅</td></tr>
<tr><td>Trigger-/Benachrichtigungskanäle</td><td align="center">21</td><td align="center">11+</td><td align="center">5</td><td align="center">15+</td></tr>
...
| **v1.8.0** | Flottenmanagement und Live-Konfiguration | **In `dev/v1.8` integriert, noch unveröffentlicht:** SQLite, Freigabe-Warteschlange, YAML-Konfiguration, begrenzte Editoren für Watcher-, Benachrichtigungs- und Aktionsrichtlinien sowie Sicherheitsübersichtsvorlagen, parallele und selektive Massenupdates ([#232](https://github.com/CodesWhat/drydock/discussions/232)), Abhängigkeits-UI, Image-Inventar und Bereinigung, Flottenstatus und Inventaraktualisierung, teilbare Label-Gruppierung, Wartungsfenster nur für Installationen ([#946](https://github.com/CodesWhat/drydock/discussions/946)), eigene Authentifizierung, bereichsbezogene API-Schlüssel ([#469](https://github.com/CodesWhat/drydock/discussions/469)) und Home-Assistant-Fortschritt/Geräte ([#210](https://github.com/CodesWhat/drydock/discussions/210)). **In Prüfung:** exaktes Gruppenrouting nur für Benachrichtigungen ([#1251](https://github.com/CodesWhat/drydock/pull/1251)). **Offen:** Erweiterte Live-Konfiguration und vererbte Gruppen-/Aktionsrichtlinien brauchen Entscheidungen zur Zuständigkeit; TOTP braucht einen freigegebenen Entwurf; der Watcher für statische Image-Listen bleibt bis nach GA zurückgestellt. |
...
**Offene Community-Anforderungen:** Hostübergreifende Abhängigkeitsupdates und Neustarts ([#219](https://github.com/CodesWhat/drydock/discussions/219)), ein Reifegrad anhand der Anzahl von Veröffentlichungen ([#558](https://github.com/CodesWhat/drydock/discussions/558)) und ein flottenweiter Standard für Digest-Prüfungen ([#657](https://github.com/CodesWhat/drydock/discussions/657)) sind noch nicht implementiert. Die Abhängigkeitsreihenfolge auf demselben Host und ihre neue UI erfüllen die Anfrage für entfernte Hosts nicht. Die Erkennung lokaler Builds und die sichere Auswahl einer Neuaufbau-Aktion bleiben zukünftige Arbeit ([#897](https://github.com/CodesWhat/drydock/discussions/897)); keiner dieser Einträge ist eine Zusage für einen Veröffentlichungstermin.
