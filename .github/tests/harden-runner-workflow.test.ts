...
const hardenRunnerRef = 'step-security/harden-runner@e14015d583714f6e62063499dc959a02595150a1';
const hardenRunnerVersion = 'v2.21.1';
...
const expectedPolicy: Record<string, EgressPolicy> = {
  ...
  // quality-mutation-monthly.yml, quality-portwing-fleet-soak.yml, and
  // security-grype.yml's grype-deps job are not part of the v1.7 CI-pipeline
  // backport onto this branch (fix/v1.6-backports only ports the jobs behind
  // ruleset 20957219's required contexts), so they stay at the 'audit'
  // default here until a later change flips them too.
};
