...
| `DD_NOTIFICATION_GOTIFY_{trigger_name}_TOKEN` | 🔴 | The Gotify app token url | A valid gotify app token | |
...
services:
  drydock:
    ...
    environment:
      ...
      - DD_NOTIFICATION_GOTIFY_LOCAL_TOKEN=AWp8A.TbBO3xpn4
```
...
docker run \
  ...
  -e DD_NOTIFICATION_GOTIFY_LOCAL_TOKEN="AWp8A.TbBO3xpn4" \
  ...
  codeswhat/drydock
```
</Tab>
