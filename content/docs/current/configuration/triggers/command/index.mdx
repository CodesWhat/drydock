...
## Migration note (upgrading from pre-v1.5.1)

Before v1.5.1, the subprocess inherited the entire drydock process environment, including every `DD_*` secret. Starting in v1.5.1, only a restricted allowlist is passed by default.
