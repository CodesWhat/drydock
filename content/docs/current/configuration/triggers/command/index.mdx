...
| `DD_ACTION_COMMAND_{trigger_name}_CONCURRENCY` | ⚪ | Max simultaneous command executions through this trigger; overrides the global [`DD_UPDATE_CONCURRENCY`](/docs/configuration/actions#update-concurrency) | Positive integer | inherits the global value (`1`) |
