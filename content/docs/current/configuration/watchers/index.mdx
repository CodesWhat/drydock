...
- **systemd-managed containers are not restarted by Drydock** — a container started by a systemd unit (e.g. via Quadlet) needs to be restarted through systemd, not by Drydock issuing its usual container-recreate calls
