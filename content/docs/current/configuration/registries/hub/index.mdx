...
services:
  drydock:
    ...
    environment:
      ...
      - DD_REGISTRY_HUB_PUBLIC_TOKEN=fb4d5db9-e64d-3648-8846-74d0846e55de
```
...
docker run \
  ...
  -e DD_REGISTRY_HUB_PUBLIC_TOKEN="fb4d5db9-e64d-3648-8846-74d0846e55de" \
  ...
  codeswhat/drydock
```
</Tab>
...
Concatenate `$username:$password` and [encode with Base64](https://www.base64encode.org/).
