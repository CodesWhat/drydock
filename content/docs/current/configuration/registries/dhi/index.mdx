...
| --- | :---: | --- | --- | --- |
| `DD_REGISTRY_DHI_{REGISTRY_NAME}_LOGIN` | ⚪ | Docker ID login | Required with `PASSWORD` | |
...
| `DD_REGISTRY_DHI_{REGISTRY_NAME}_TOKEN` | ⚪ | **Deprecated** — use `PASSWORD` instead (accepted as an alias until v1.6.0) | `DD_REGISTRY_DHI_{REGISTRY_NAME}_LOGIN` must be defined | |
