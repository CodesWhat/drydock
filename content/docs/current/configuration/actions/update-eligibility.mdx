...
- **Side panel and container full-page view** — the **Update Status** panel shows one plain-language summary followed by the active conditions. Actionable conditions link to the relevant trigger, update-policy, security, audit, or watcher surface. Time-limited conditions retain their countdown and exact lift time.
