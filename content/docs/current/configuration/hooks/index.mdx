...
Hook commands are validated against a restricted shell-safe grammar at configuration time. Commands containing any of the following are rejected at startup with a clear error:
