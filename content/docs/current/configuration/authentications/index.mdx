...
Remember-me works with both Basic and OIDC authentication strategies. The preference is stored server-side in the session via `POST /auth/remember` before the auth flow begins.
