...
environment:
  ...
  # - DD_NOTIFICATION_SMTP_ALERTS_SECURITYDIGESTTITLE=Security scan complete: $scanCount containers scanned
  # - DD_NOTIFICATION_SMTP_ALERTS_SECURITYDIGESTBODY=Found $alertCount containers with alerts
```
