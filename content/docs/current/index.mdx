...
- 🔔 20+ trigger types with per-event/provider notification templates, live preview, and bell preferences
...
- 🌐 [Distributed agents](/docs/configuration/agents) for remote Docker hosts
- 📊 Prometheus metrics and Grafana dashboard
- 🧩 Customizable zero-dependency dashboard grid with responsive drag, resize, and widget visibility
...
- [Distributed agents](/docs/configuration/agents) — monitor containers across multiple Docker hosts from one UI
- [Container log viewer](/docs/configuration/logs) — stream and search container logs
- [Debug dump](/docs/api/app#download-diagnostic-debug-dump) — export diagnostic snapshots for troubleshooting
