...
| `hotUpdates` | integer | Number of containers whose `updateMaturityLevel` is `hot` |
| `matureUpdates` | integer | Number of containers whose `updateMaturityLevel` is `mature` or `established` |
