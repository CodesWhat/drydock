...
[
  {
    ...
    "displayIcon": "mdi:home-assistant",
    "status": "running",
    "watcher": "local",
    "includeTags": "^\\d+\\.\\d+.\\d+$",
    "image": {
    ...
    "updateDetectedAt": "2021-06-15T10:30:00.000Z",
    "details": {
      "ports": ["8123:8123/tcp"],
    ...
    "security": {
      "scan": {
        "scanner": "trivy",
        "image": "homeassistant/home-assistant:2021.6.5",
        "scannedAt": "2021-06-15T11:00:00.000Z",
        "status": "passed",
...
```bash
curl -X POST http://drydock:3000/api/containers/31a61a8305ef1fc9a71fa4f20a68d7ec88b28e32303bbc4a5f192e851165b816/triggers/agent1/ntfy/one
```
