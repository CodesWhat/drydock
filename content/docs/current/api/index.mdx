...
| `dd:scan-completed` | `{ "containerId": "...", "status": "...", "cycleId": "..." }` | A security scan finished; `cycleId` is present for bulk scans and optional otherwise. Correlate bulk progress using `cycleId` and deduplicate by `containerId` |
