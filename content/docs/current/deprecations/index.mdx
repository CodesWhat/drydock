...
| **Migration** | Switch custom healthcheck overrides to `test: /bin/healthcheck ${DD_SERVER_PORT:-3000}`, or drop the override to use the built-in image healthcheck. See [Monitoring](/docs/monitoring) |
