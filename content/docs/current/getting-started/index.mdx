...
<Tab value="Other">
Drydock supports 20 trigger integrations — 17 notification channels plus 3 action providers (Docker, Docker Compose, Command). See the [Triggers configuration](/docs/configuration/triggers) page for all options including Telegram, Teams, Matrix, Gotify, Pushover, Apprise, IFTTT, HTTP webhooks, Kafka, MQTT, and more.
</Tab>
</Tabs>
