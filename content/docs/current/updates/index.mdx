...
## v1.6.1-rc.14 Highlights — September 15, 2026

Home Assistant discovery and state publishing now agree for agent containers
when MQTT agent topic segmentation is enabled. The 1.6 default remains
`HASS_AGENTTOPICSEGMENT=false`; canonical container names and plain MQTT topics
are unchanged. Thanks to [@depuits](https://github.com/depuits) for the
reproduction details in [discussion #1201](https://github.com/CodesWhat/drydock/discussions/1201).

The candidate also refreshes the Alpine timezone package pin and fixes Crowdin
branch selection and workflow-test discovery. These runtime changes start a
fresh seven-day soak. Old retained MQTT payloads are not deleted automatically;
check for other publishers before removing obsolete state. See
[CHANGELOG.md](https://github.com/CodesWhat/drydock/blob/v1.6.1-rc.14/CHANGELOG.md#161-rc14--2026-09-15)
for the full release notes.

## v1.6.1-rc.13 Highlights — September 10, 2026
...
[CHANGELOG.md](https://github.com/CodesWhat/drydock/blob/v1.6.1-rc.13/CHANGELOG.md#161-rc13--2026-09-10)
for the full release notes.

## v1.6.1-rc.12 Highlights — September 8, 2026

Joi is updated to 18.2.8 for its template rename and custom-message prototype fixes. The website
uses Next.js 16.3.4 and baseline-browser-mapping 2.11.20, and the test suite
uses Vitest 4.1.11 for its mock redirect file-access fix. Nodemailer 9.1.1 fixes
address parsing and legacy content access, and e2e-only js-yaml 3.15.2 fixes the
empty-merge parser budget. The runtime dependency changes mean this candidate
starts a fresh seven-day soak. See
[CHANGELOG.md](https://github.com/CodesWhat/drydock/blob/main/CHANGELOG.md#161-rc12--2026-09-08)
for the full release notes.
