...
| | |
| --- | --- |
| **Deprecated since** | v1.5.0-rc.29 |
| **Removed since** | v1.5.0-rc.29 |
...
`wud.*` prefixed Docker labels are accepted as fallbacks for their `dd.*` equivalents (22 labels total including `wud.watch`, `wud.tag.include`, `wud.tag.exclude`, etc.).
