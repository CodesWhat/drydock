...
| --- | :---: | --- | --- | --- |
| `DD_REGISTRY_DHI_{REGISTRY_NAME}_LOGIN` | ⚪ | Docker ID login | Required with `PASSWORD` or deprecated `TOKEN` | |
...
| `DD_REGISTRY_DHI_{REGISTRY_NAME}_TOKEN` | ⚪ | **Deprecated** — accepted as an alias for `PASSWORD` | `DD_REGISTRY_DHI_{REGISTRY_NAME}_LOGIN` must be defined; cannot be combined with `PASSWORD` | |
