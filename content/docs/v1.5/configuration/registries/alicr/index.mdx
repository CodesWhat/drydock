...
Drydock automatically detects `registry.REGION.aliyuncs.com`, `registry-intl.REGION.aliyuncs.com`, and registry hosts ending in `cr.aliyuncs.com` or `cr.aliyuncs.com.cn` (including namespace subdomains).
