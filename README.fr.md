...
| **v1.8.0**   | Gestion de flotte et configuration en direct             | Configuration YAML, configuration de l'interface utilisateur en direct, navigateur de volumes, mises à jour parallèles, migration du magasin SQLite, progression des mises à jour Home Assistant et appareils par conteneur ([#210](https://github.com/CodesWhat/drydock/discussions/210)), images construites localement surveillées par rapport à une base upstream déclarée ([#897](https://github.com/CodesWhat/drydock/discussions/897)), clés API rotatives à portée limitée (jetons Bearer statiques pour les intégrations HA/tableau de bord, [#469](https://github.com/CodesWhat/drydock/discussions/469)), file d'attente d'approbation par mise à jour |
