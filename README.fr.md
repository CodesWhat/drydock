...
**Observateur de mise à jour d'image de conteneur : 23 registres, 21 fournisseurs de notifications et d'actions.**
...
**État des versions (16 septembre 2026) :** Le candidat v1.7 publié est [v1.7.0-rc.16](https://github.com/CodesWhat/drydock/releases/tag/v1.7.0-rc.16). Ce checkout suit le **développement v1.8, non publié** ; les fonctions v1.8 de la [feuille de route](#roadmap) ne sont pas incluses dans ce candidat. Les points forts de RC10 ci-dessous restent des notes historiques.
...
| 🔔  | **21 déclencheurs**                                    | 17 canaux de notification (Slack, Discord, Telegram, Teams, SMTP, MQTT, ntfy et plus) ainsi que des actions Docker, Docker Compose, Portainer et Command, avec des modèles par événement/fournisseur, un aperçu en direct, un filtrage de seuil et un mode batch.                                                                                                                                                                                                                                                                                                   |
...
<tr><td>Canaux de déclenchement / notification</td><td align="center">21</td><td align="center">17</td><td align="center">17</td><td align="center">~20</td></tr>
...
<tr><td>Authentification OIDC / SSO</td><td align="center">✅</td><td align="center">✅</td><td align="center">✅</td><td align="center">✅</td></tr>
<tr><td>Canaux de déclenchement / notification</td><td align="center">21</td><td align="center">11+</td><td align="center">5</td><td align="center">15+</td></tr>
...
| **v1.8.0** | Gestion de flotte et configuration en direct | **Intégré dans `dev/v1.8`, non publié :** SQLite, file d'approbation, configuration YAML, éditeurs limités de politiques des observateurs/notifications/actions et modèles de résumés de sécurité, mises à jour parallèles et sélectives en masse ([#232](https://github.com/CodesWhat/drydock/discussions/232)), interface des dépendances, inventaire et nettoyage des images, état de flotte et actualisation de l'inventaire, regroupement par étiquette partageable, fenêtres de maintenance limitées aux installations ([#946](https://github.com/CodesWhat/drydock/discussions/946)), authentification interne, clés API à portée limitée ([#469](https://github.com/CodesWhat/drydock/discussions/469)) et progression/appareils Home Assistant ([#210](https://github.com/CodesWhat/drydock/discussions/210)). **En revue :** routage par groupe exact réservé aux notifications ([#1251](https://github.com/CodesWhat/drydock/pull/1251)). **À venir :** La configuration en direct étendue et les politiques héritées des groupes et des actions exigent des décisions sur la propriété des réglages ; TOTP attend un contrat approuvé ; l'observateur de listes d'images statiques reste reporté après GA. |
...
**Demandes communautaires encore ouvertes :** Les mises à jour et redémarrages de dépendances entre hôtes ([#219](https://github.com/CodesWhat/drydock/discussions/219)), la maturité fondée sur le nombre de versions ([#558](https://github.com/CodesWhat/drydock/discussions/558)) et une valeur par défaut pour les vérifications de digest sur toute la flotte ([#657](https://github.com/CodesWhat/drydock/discussions/657)) ne sont pas implémentés. L'ordre des dépendances sur un même hôte et sa nouvelle interface ne répondent pas à la demande concernant les hôtes distants. La détection des builds locaux et le choix sûr d'une action de reconstruction restent à développer ([#897](https://github.com/CodesWhat/drydock/discussions/897)) ; aucune de ces entrées ne constitue un engagement sur une date de sortie.
