...
Docker · Docker Compose · Portainer · Commande
...
| **v1.7.0**   | Mises à jour intelligentes et UX                         | Ordre tenant compte des dépendances ([#219](https://github.com/CodesWhat/drydock/discussions/219)), mises à jour sélectives en masse ([#232](https://github.com/CodesWhat/drydock/discussions/232)), politique de mise à jour par action ([#511](https://github.com/CodesWhat/drydock/discussions/511)), élagage d'image, surveillance d'image statique, horloge unifiée de maturité/âge des mises à jour, liens de port cliquables, raccourcis clavier, PWA, amélioration du contraste du thème sombre (WCAG 2.2) ([#850](https://github.com/CodesWhat/drydock/issues/850), [#865](https://github.com/CodesWhat/drydock/discussions/865)), suppression de `DD_TRIGGER_*` (fin de la fenêtre de dépréciation de la v1.5.0), curl supprimé de l'image                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **v1.8.0**   | Gestion de flotte et configuration en direct             | Configuration YAML, configuration de l'interface utilisateur en direct, navigateur de volumes, mises à jour parallèles, migration du magasin SQLite, chaîne d'authentification propriétaire remplaçant Passport.js (déjà livrée), authentification à deux facteurs TOTP, progression des mises à jour Home Assistant et appareils par conteneur ([#210](https://github.com/CodesWhat/drydock/discussions/210)), images construites localement surveillées par rapport à une base upstream déclarée ([#897](https://github.com/CodesWhat/drydock/discussions/897)), clés API à portée limitée, avec limites de débit par clé et révocation en cascade, pour les intégrations HA/tableau de bord ([#469](https://github.com/CodesWhat/drydock/discussions/469)), file d'attente d'approbation par mise à jour |
| **v2.0+**                    | Extension de la plateforme et au-delà                    | Observateurs Swarm/Kubernetes, GitOps, barrières de santé, déploiements Canary, terminal Web, RBAC, LDAP/AD, fournisseur Podman natif au-delà de l'API compatible Docker, CLI, image renforcée Wolfi, proxy de socket                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
